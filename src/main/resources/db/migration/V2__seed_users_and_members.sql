...
INSERT INTO users (id, username, full_name, email, active) VALUES
(10, 'prof_layton', 'Profesor Layton', 'layton@example.com', true),
(20, 'student_alice', 'Alice Estudiante', 'alice@example.com', true),
(21, 'student_bob', 'Bob Estudiante', 'bob@example.com', true)
ON CONFLICT (id) DO NOTHING;

-- Crear un equipo para ese proyecto
INSERT INTO teams (id, name, project_id) VALUES (301, 'Equipo Alfa', 201)
ON CONFLICT (id) DO NOTHING;
...
(101, 'Ingeniería de Software II', 'Curso enfocado en el desarrollo ágil y colaborativo de software.')
ON CONFLICT (id) DO NOTHING;

-- Crear un proyecto para ese curso
INSERT INTO projects (id, name, description, status_id, course_id) VALUES
(201, 'InnoSistemas Plataforma de Feedback', 'Desarrollar la plataforma web para la gestión de proyectos.', 1, 101)
ON CONFLICT (id) DO NOTHING;
